...
STATIVFILES_VENDOR_DIR = getattr(settings, "STATICFILES_VENDOR_DIR")
VENDIR_STATICFILES = {
...
class Command(BaseCommand):
    ...
    def handle(self, *args:Any , **options:Any):
        ...
        completed_urls=[]
        for name , url in VENDIR_STATICFILES.items():
             out_path = STATIVFILES_VENDOR_DIR / name
        ...
        if set(completed_urls) == set(VENDIR_STATICFILES.values()):
